...
function getRef(url){
	...
	var returnvalue = window.showModalDialog(url,window,"dialogHeight: "+iHeight+"px;dialogWidth: "+iWidth+"px;dialogTop: "+iTop+";dialogLeft: "+iLeft+";resizable:no;status: no;scroll:no");
	// -注意
	if (!returnvalue) {
		returnvalue = window.returnValue;
	}
	$("#name").val(returnvalue);
}
